...
| (_| | (_) | (_| | |_| |
 ...
 |___/          |_|
```
[![GitHub tag](https://img.shields.io/github/tag/doug-martin/goqu.svg?style=flat)](https://github.com/yz89122/goqu/v10/releases)
[![Test](https://github.com/yz89122/goqu/v10/workflows/Test/badge.svg?branch=master&event=push)](https://github.com/yz89122/goqu/v10/actions?query=workflow%3ATest+and+branch%3Amaster+)
[![Go Reference](https://pkg.go.dev/badge/github.com/yz89122/goqu/v10.svg)](https://pkg.go.dev/github.com/yz89122/goqu/v10)
[![codecov](https://codecov.io/gh/doug-martin/goqu/branch/master/graph/badge.svg)](https://codecov.io/gh/doug-martin/goqu)
[![Go Report Card](https://goreportcard.com/badge/github.com/yz89122/goqu/v10)](https://goreportcard.com/report/github.com/yz89122/goqu/v10)
...
```sh
go get -u github.com/yz89122/goqu/v10
```

If you are not using go modules...

**NOTE** You should still be able to use this package if you are using go version `>v1.10` but, you will need to drop the version from the package. `import "github.com/yz89122/goqu/v10` -> `import "github.com/yz89122/goqu/v10"`
...
### Running tests
The test suite requires a postgres, mysql and sqlserver databases. You can override the connection strings with the [`MYSQL_URI`, `PG_URI`, `SQLSERVER_URI` environment variables](https://github.com/yz89122/goqu/v10/blob/2fe3349/docker-compose.yml#L26)*
...
```sh
MYSQL_VERSION=8 POSTGRES_VERSION=14 SQLSERVER_VERSION=2017-CU8-ubuntu GO_VERSION=1.16 docker-compose run goqu
```
